package me.blueslime.bluegens.modules.utils.list;
...
public class ReturnableArrayList<T> extends AbstractList<T> implements List<T>, RandomAccess, Cloneable, Serializable {

    private final ArrayList<T> list = new ArrayList<>();

    public ReturnableArrayList() { }

    public ReturnableArrayList(List<T> list) {
    ...
    public ReturnableArrayList<T> addValue(T value) {
        add(value);
        return this;
    }

    @SafeVarargs
    public final ReturnableArrayList<T> addValues(T... values) {
        addAll(Arrays.asList(values));
        return this;
    }

    public ReturnableArrayList<T> replace(UnaryOperator<T> operator) {
        replaceAll(operator);
        return this;
    }
    ...
    @Override
    public ReturnableArrayList<T> clone() {
        try {
            return (ReturnableArrayList<T>) super.clone();
