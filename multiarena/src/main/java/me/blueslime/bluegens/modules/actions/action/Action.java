package me.blueslime.bluegens.modules.actions.action;
...
public abstract class Action {
     ...
     */
    public void execute(BlueGens plugin, String parameter, Player... players) {
     ...
     * @param parameter text
     */
    public abstract void execute(BlueGens plugin, String parameter, List<Player> players);
